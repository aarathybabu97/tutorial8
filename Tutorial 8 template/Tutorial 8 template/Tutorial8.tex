...
\author{\sf\Large\textbf{ XXX XXXX}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ Aarathy Babu}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ XXX XXX}\\ {\sf\large XXX\\[0.5cm]}}

\date{\sf\Date~\Month~\Year}
\makeatletter
\lfoot{\sf XXXX, Babu, XXX: \@date}
\makeatother
...
\caption{\label{tab:table}Total cases}\\
\toprule
country & year & n\\
\midrule
\rowcolor{gray!6}  China & 2019 & 27\\
China & 2020 & 83964\\
\rowcolor{gray!6}  India & 2019 & 0\\
India & 2020 & 62939\\
\bottomrule
\end{longtable}
...
\begin{verbatim}
## # A tibble: 261 x 6
##      day month  year cases deaths country
##    <dbl> <dbl> <dbl> <dbl>  <dbl> <chr>  
##  1    10     5  2020    15      0 China  
##  2     9     5  2020     0      0 China  
##  3     8     5  2020     6      0 China  
##  4     7     5  2020     2      0 China  
##  5     6     5  2020     2      0 China  
##  6     5     5  2020     2      0 China  
##  7     4     5  2020     3      0 China  
##  8     3     5  2020     2      0 China  
##  9     2     5  2020     3      0 China  
## 10     1     5  2020    12      0 China  
## # ... with 251 more rows
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{Tutorial8_files/figure-latex/plot -1.pdf}
\caption{(\#fig:plot )Cases in India has soared while Cases in China has decreased over time}
\end{figure}
